 ...
 * @end: end index
 */
void tdms(int *arr, int start, int mid, int end, int *c_arr)
{
	int i = 0, j = 0, k = 0;
 ...
 * Return: nothing
 */
void tdmsp(int *c_arr, size_t start, size_t end, int *arr)
{
	size_t mid = 0;
	...
	tdmsp(arr, start, mid, c_arr);
	tdmsp(arr, mid, end, c_arr);
	tdms(c_arr, start, mid, end, arr);
	printf("Merging...\n");
	printf("[left]: ");
